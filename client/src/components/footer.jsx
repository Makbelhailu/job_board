...
const Footer = () => {
  ...
  return (
    <div className="footer_container m-0 mt-8 grid w-full grid-cols-5 items-start justify-between gap-14 rounded-t-3xl bg-secondary px-6 pb-2 pt-6 text-left text-white sm:grid-cols-2 xs:grid-cols-1">
      <div className="overall lg:col-span-2 xl:col-span-2 ">
